...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path', type=str, default='experiment/odometry_EVAL_KITTI_2024-07-03_14-15/eval/odometry_07/07_pred.txt',  help='Directory path of pose')

    args = parser.parse_args()
    output_path = "test_data/07_pred.txt"
