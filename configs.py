...
def dynamic_seg_args():
    ...
    parser.add_argument('--lidar_root', default='/home/ifly/RhDataHouse/dataset/Kitti_odom/sequences', help='Dataset directory [default: /dataset]')
...
def dynamic_seg_infer_args():
    ...
    parser.add_argument('--lidar_root', default='/home/ifly/RhDataHouse/dataset/school/sequences', help='Dataset directory [default: /dataset]')
    parser.add_argument('--image_root', default='/dataset/data_odometry_color', help='Dataset directory [default: /dataset]')
    parser.add_argument('--log_dir', default='log_train', help='Log dir [default: log_train]')
...
def odometry_tracking_args():
    ...
    parser.add_argument('--lidar_root', default='/home/ifly/RhDataHouse/dataset/kitti_tracking/training', help='Dataset directory [default: /dataset]')
    parser.add_argument('--image_root', default='/dataset/data_odometry_color', help='Dataset directory [default: /dataset]')
    parser.add_argument('--log_dir', default='log_train', help='Log dir [default: log_train]')
...
def odometry_school_args():
    ...
    parser.add_argument('--limit_or_filter', type=bool, default=True, help='if False, filter will reserve 40m~50m points')
    parser.add_argument('--batch_size', type=int, default=2, help='Batch Size during training [default: 16]')
    parser.add_argument('--eval_batch_size', type=int, default=2, help='Batch Size during evaling [default: 64]')#original is 1
    parser.add_argument('--eval_before', type=int, default=0, help='if 1, eval before train')

    parser.add_argument('--lidar_root', default='/home/ifly/RhDataHouse/dataset/school_Dy/sequences', help='Dataset directory [default: /dataset]')
    parser.add_argument('--image_root', default='/dataset/data_odometry_color', help='Dataset directory [default: /dataset]')
    parser.add_argument('--log_dir', default='log_train', help='Log dir [default: log_train]')
